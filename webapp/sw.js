...
var CACHE_VERSION = "miniapp-v1-20260923-gpt-chips-caret";
var SHELL_CACHE = CACHE_VERSION + "-shell";

var PRECACHE_URLS = [
  "./",
  "./index.html",
  "./styles.css?v=20260923-gpt-chips-caret",
  "./app.js?v=20260923-gpt-chips-caret",
  "./note-html.js?v=20260923-gpt-chips-caret",
  "./note-comments.js?v=20260923-gpt-chips-caret",
  "./note-rich-editor.js?v=20260923-gpt-chips-caret",
  "./icons/arrow-up-right.svg?v=20260923-gpt-chips-caret",
  "./icons/chevron-up-muted.svg?v=20260923-gpt-chips-caret",
  "./icons/chevron-up-on-fill.svg?v=20260923-gpt-chips-caret",
